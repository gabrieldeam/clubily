// src/components/CashbackOverview/CashbackOverview.tsx
'use client';
...
import styles from './CashbackOverview.module.css';
...
export default function CashbackOverview() {
